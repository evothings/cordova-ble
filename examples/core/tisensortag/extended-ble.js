// File with extended BLE API. This file is used for development,
// to not have to rebuild the plugin each time the JS code is changed.

// Wrap BLE API in a function to be called when Cordova has
// loaded to overwrite the plugin definitions with this code.
window.extendBLEPluginAPI = function()
{

// exports does not exist in this context, set it explicitly
// to the namespace to overwrite.
...
* @param {DeviceInfo} device - Device object or a device handle from {@link connectCallback}.
* @param {Characteristic} characteristic - Characteristic object or handle from {@link characteristicCallback}.
...
* @param {emptyCallback} success - Called when the remote device has confirmed the write.
